      ...
      >
        ...
        <div>
          <Menu>
            ...
            <MenuList bg="#2d3748" color="white" pl={2}>
          ...
          <Menu>
            <MenuButton as={Button} bg="#282c3c" rightIcon={<ChevronDownIcon />}>
              <Avatar
                size="sm"
                cursor="pointer"
                name={user.name}
            ...
            <MenuList bg="#2d3748" color="white">
              <ProfileModal user={user}>
                <MenuItem bg="transparent" _hover={{ bg: "#4A5568" }}>
                  My Profile
                </MenuItem>{" "}
              </ProfileModal>
              <MenuDivider />
